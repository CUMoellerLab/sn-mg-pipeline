...
rule sort_index_bam:
    ...
    benchmark:
        "output/benchmarks/sort_bam/{mapper}/{read_sample}_Mapped_To_{contig_sample, [A-Za-z0-9_]+}.sorted.txt"
    log:
        "output/logs/sort_bam/{mapper}/{read_sample}_Mapped_To_{contig_sample, [A-Za-z0-9_]+}.sorted.log"
    shell:
        """
